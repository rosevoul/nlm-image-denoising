%% SCRIPT: NLM_SHARED_KERNEL
%
% GPU shared kernel for NLM filter
%
% DEPENDENCIES
%
%  nlmKernel.cu
%% 
 ...
 %%------------------PIPELINE------------------------%%
  ...
  k = parallel.gpu.CUDAKernel( '../cuda/nlm_shared/nlmSharedKernel.ptx', ...
  ...
  imwrite(B, '../data/cuda_lena_5_shared.png')
